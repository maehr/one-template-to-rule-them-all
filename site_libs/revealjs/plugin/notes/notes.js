(function(I,S){typeof exports=="object"&&typeof module<"u"?module.exports=S():typeof define=="function"&&define.amd?define(S):(I=typeof globalThis<"u"?globalThis:I||self).RevealNotes=S()})(this,function(){"use strict";function I(){return{async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let S={async:!1,baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,hooks:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1};const D=/[&<>"']/,X=new RegExp(D.source,"g"),U=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,G=new RegExp(U.source,"g"),tt={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},Z=h=>tt[h];function b(h,n){if(n){if(D.test(h))return h.replace(X,Z)}else if(U.test(h))return h.replace(G,Z);return h}const et=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/gi;function H(h){return h.replace(et,(n,t)=>(t=t.toLowerCase())==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):"")}const nt=/(^|[^\[])\^/g;function k(h,n){h=typeof h=="string"?h:h.source,n=n||"";const t={replace:(e,s)=>(s=(s=s.source||s).replace(nt,"$1"),h=h.replace(e,s),t),getRegex:()=>new RegExp(h,n)};return t}const st=/[^\w:]/g,it=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function j(h,n,t){if(h){let e;try{e=decodeURIComponent(H(t)).replace(st,"").toLowerCase()}catch{return null}if(e.indexOf("javascript:")===0||e.indexOf("vbscript:")===0||e.indexOf("data:")===0)return null}n&&!it.test(t)&&(t=function(e,s){M[" "+e]||(rt.test(e)?M[" "+e]=e+"/":M[" "+e]=q(e,"/",!0)),e=M[" "+e];const a=e.indexOf(":")===-1;return s.substring(0,2)==="//"?a?s:e.replace(at,"$1")+s:s.charAt(0)==="/"?a?s:e.replace(ot,"$1")+s:e+s}(n,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const M={},rt=/^[^:]+:\/*[^/]*$/,at=/^([^:]+:)[\s\S]*$/,ot=/^([^:]+:\/*[^/]*)[\s\S]*$/,C={exec:function(){}};function B(h,n){const t=h.replace(/\|/g,(s,a,r)=>{let i=!1,o=a;for(;--o>=0&&r[o]==="\\";)i=!i;return i?"|":" |"}).split(/ \|/);let e=0;if(t[0].trim()||t.shift(),t.length>0&&!t[t.length-1].trim()&&t.pop(),t.length>n)t.splice(n);else for(;t.length<n;)t.push("");for(;e<t.length;e++)t[e]=t[e].trim().replace(/\\\|/g,"|");return t}function q(h,n,t){const e=h.length;if(e===0)return"";let s=0;for(;s<e;){const a=h.charAt(e-s-1);if(a!==n||t){if(a===n||!t)break;s++}else s++}return h.slice(0,e-s)}function J(h,n){if(n<1)return"";let t="";for(;n>1;)1&n&&(t+=h),n>>=1,h+=h;return t+h}function Q(h,n,t,e){const s=n.href,a=n.title?b(n.title):null,r=h[1].replace(/\\([\[\]])/g,"$1");if(h[0].charAt(0)!=="!"){e.state.inLink=!0;const i={type:"link",raw:t,href:s,title:a,text:r,tokens:e.inlineTokens(r)};return e.state.inLink=!1,i}return{type:"image",raw:t,href:s,title:a,text:b(r)}}class P{constructor(n){this.options=n||S}space(n){const t=this.rules.block.newline.exec(n);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(n){const t=this.rules.block.code.exec(n);if(t){const e=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?e:q(e,`
...
`)}(e,t[3]||"");return{type:"code",raw:e,lang:t[2]?t[2].trim().replace(this.rules.inline._escapes,"$1"):t[2],text:s}}}heading(n){const t=this.rules.block.heading.exec(n);if(t){let e=t[2].trim();if(/#$/.test(e)){const s=q(e,"#");this.options.pedantic?e=s.trim():s&&!/ $/.test(s)||(e=s.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:e,tokens:this.lexer.inline(e)}}}hr(n){const t=this.rules.block.hr.exec(n);if(t)return{type:"hr",raw:t[0]}}blockquote(n){const t=this.rules.block.blockquote.exec(n);if(t){const e=t[0].replace(/^ *>[ \t]?/gm,""),s=this.lexer.state.top;this.lexer.state.top=!0;const a=this.lexer.blockTokens(e);return this.lexer.state.top=s,{type:"blockquote",raw:t[0],tokens:a,text:e}}}list(n){let t=this.rules.block.list.exec(n);if(t){let e,s,a,r,i,o,c,d,l,p,w,T,y=t[1].trim();const _=y.length>1,f={type:"list",raw:"",ordered:_,start:_?+y.slice(0,-1):"",loose:!1,items:[]};y=_?`\\d{1,9}\\${y.slice(-1)}`:`\\${y}`,this.options.pedantic&&(y=_?y:"[*+-]");const A=new RegExp(`^( {0,3}${y})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;n&&(T=!1,t=A.exec(n))&&!this.rules.block.hr.test(n);){if(e=t[0],n=n.substring(e.length),d=t[2].split(`
